<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="./index.php?page=home">Bus Booking System</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block" id='top-nav'>
        <ul>
          ...
          <li class="drop-down nav-bus nav-location"><a href="#">Update</a>
            <ul>
          ...
          <li class="drop-down nav-user"><a href="#"><?php echo $_SESSION['login_name'] ?> </a>
             <ul>
              ...
              <li><a href="javascript:void(0)" id="manage_account">Account Settings</a></li>
